            ...
            await sock.sendMessage(sock.user.id, {
              ...
              contextInfo: {
                ...
                forwardedNewsletterMessageInfo: newsletterData.newsletterId ? {
                  ...
                  newsletterName: newsletterData.newsletterName || "POPKID-MD",
                  serverMessageId: -1
                } : undefined,
                externalAdReply: {
                  title: newsletterData.botName || "POPKID-MD",
                  body: newsletterData.botDescription || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ popkid-ke",
