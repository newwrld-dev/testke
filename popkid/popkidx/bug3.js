import bugchat from '../../bug/popkid3.js';
...
const blastAttack = async (m, Matrix) => {
  ...
  if (!m.isGroup && isGroupLink) {
    ...
    try {
      ...
      await Matrix.sendMessage(senderId, { text: `✅ *ᴘᴏᴘᴋɪᴅ ᴍᴅ* completed on group.` }, { quoted: m });
  ...
  await Matrix.sendMessage(m.from, {
    text: `❌ Usage :\n.popkid-blast https://chat.whatsapp.com/xxxxx (from DM)\n.inconnu-blast (from group)`,
  }, { quoted: m });
};
