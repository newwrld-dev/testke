  ...
  if (validCommands.includes(cmd)) {
    ...
    if (!url) {
      ...
      return await sock.sendMessage(
        ...
        { text: "ρℓєαѕє ρяσνι∂є α υяℓ тσ ѕнσятєη. єχαмρℓє:!shortenurl https://github.com/popkidmd/POPKID-MD*" },
...

          {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                ...
                sourceUrl: "https://whatsapp.com/channel/0029VacgxK96hENmSRMRxx1r", // Source URL
